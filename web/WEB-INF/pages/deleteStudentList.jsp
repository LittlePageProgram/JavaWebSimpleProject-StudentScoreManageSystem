...
<html>
	...
	<body>
		...
		<div id="form2">
			<form action="${pageContext.request.contextPath }/DeleteStudentGetSnum" method="post">
				<div class="mdui-textfield" id="user">
				    <div class="mdui-textfield">
					    <label class="mdui-textfield-label">请输入要删除的学生学号：</label>
